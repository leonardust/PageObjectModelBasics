...
public class TestConfig{
	...
	public static String server="smtp.poczta.onet.pl";
	public static String from = "leo.leo@adres.pl";
	public static String password = "RmRRr1ouCoXs9VDg";
	public static String[] to ={"jodlllla66@gmail.com"};
